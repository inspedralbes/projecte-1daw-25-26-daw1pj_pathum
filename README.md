...
## OBJECTIUS
Fer una web per gestionar les incidències tècniques de l'institut. Els professors obren tickets, els tècnics els resolen i l'admin assigna i supervisa. Tot des del navegador, sense instal·lar res.
