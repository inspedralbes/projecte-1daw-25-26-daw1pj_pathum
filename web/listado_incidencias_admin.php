...
<head>
  ...
  <title>Llistat Incidències - Admin</title>
...
<body class="bg-light">
  ...
  <div class="container mt-5 mb-5 pb-5">
    ...
    <div class="d-flex gap-3 mb-4">
      <a href="listado_incidencias_finalizadas_admin.php" class="btn btn-info text-white px-4 py-2 shadow-sm fw-bold">FINALITZADES</a>
      <a href="listado_incidencias_pendientes_admin.php" class="btn btn-info text-white px-4 py-2 shadow-sm fw-bold">PENDENTS</a>
    </div>

    <h2 class="mb-4 fw-bold">Llistat de totes les Incidències</h2>
            ...
            <?php if ($result && $result->num_rows > 0): ?>
              <?php while ($row = $result->fetch_assoc()): ?>
                ...
                <tr>
                  ...
                  <td><a href="asignar_incidencia.php?id=<?= $row['idIncidencia'] ?>" class="btn btn-sm btn-info fw-bold shadow-sm">Assignar</a></td>
                </tr>
              <?php endwhile; ?>
            <?php else: ?>
              <tr>
                <td colspan="9" class="text-center text-muted py-4">No hi ha incidències registrades.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
    ...
    <div class="d-flex justify-content-between mt-4">
      ...
      <a href="interfaz_admin.php" class="btn btn-secondary shadow-sm fw-bold">VOLVER</a>
    </div>
