...
<head>
  ...
  <title>Incidències Pendents - Admin</title>
...
<body class="bg-light">
  ...
  <div class="container mt-5 mb-5 pb-5">
    ...
    <h2 class="mb-4 fw-bold">Llistat de les Incidències pendents</h2>
    ...
    <div class="table-responsive shadow-sm rounded">
        <table class="table table-secondary table-hover align-middle mb-0">
          ...
          <tbody>
            ...
            <?php else: ?>
              <tr>
                <td colspan="7" class="text-center text-muted py-4">No hi ha incidències pendents.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
