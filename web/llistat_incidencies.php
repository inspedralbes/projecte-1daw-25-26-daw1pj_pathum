...
$resultat = $conn->query("SELECT idIncidencia, descripcio, data FROM INCIDENCIA WHERE tecnic = $idTecnic AND dataFinalitzacio IS NULL");
?>
<!DOCTYPE html>
<html lang="ca">
<head>
    ...
    <div class="container text-center" style="max-width: 700px;">
                    ...
                    <tbody>
                        <?php while ($inc = $resultat->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td class="py-3">
                                    <a href="gestionar_incidencia.php?id=<?= $inc['idIncidencia'] ?>" class="btn btn-info btn-sm fw-bold shadow-sm">
                                        Gestionar
                                    </a>
                                </td>
                            </tr>
        ...
        <?php else: ?>
            <div class="alert alert-success py-4 shadow-sm fw-bold">
                 No tens cap incidència pendent!
            </div>
        <?php endif; ?>
